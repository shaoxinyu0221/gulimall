package com.gulimall.product.util;
...
public class MybatisPlusCodeUtil {
    ...
    private static final String ENTITY_IGNORE_PREFIX = "pms_";
    ...
    public static void main(String[] args) {
        try {
            generator("sxy",//作者
                    "jdbc:mysql://81.68.64.142:3306/gulimall_pms?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai",
                    "com.mysql.cj.jdbc.Driver",//数据库驱动
                    "root",//数据库帐号
                    "root",//数据库密码
                    "com.gulimall.product",//项目最大的包名
                    "gulimall-product",//项目名或项目模块名
                    "pms_attr,pms_attr_group,pms_brand,pms_category,pms_sku_images,pms_sku_info,pms_spu_comment,pms_spu_images,pms_spu_info,pms_spu_info_desc");//要操作的表名,多个表名用逗号隔开
...
//        globalConfig.setOutputDir(projectPath + "\\" + projectModule + "\\src\\main\\java");
    ...
    private static PackageConfig packageConfig(String parentPackage) {
        ...
        //各个包目录起名
        packageConfig.setEntity("dao.po");
        packageConfig.setMapper("dao.mysql");
        packageConfig.setXml("mysql");
